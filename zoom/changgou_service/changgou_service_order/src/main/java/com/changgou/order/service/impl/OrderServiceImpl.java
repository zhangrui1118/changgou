...
public class OrderServiceImpl implements OrderService {
    ...
    public List index(String username) {
        return myOrderMapper.selectIndex(username);
    }
    ...
    public List pay(String username) {
        return myOrderMapper.selectPay(username);
    }
    ...
    public List send(String username) {
        return myOrderMapper.selectSend(username);
    }
    ...
    public List receive(String username) {
        return myOrderMapper.selectReceive(username);
    }
    ...
    public List evaluate(String username) {
        return myOrderMapper.selectEvaluate(username);
    }
    ...
    public void cancelOrder(String orderid, String username) {
        myOrderMapper.delete_tb_order(orderid,username);
        myOrderMapper.delete_tb_order_item(orderid);
    }
    ...
    public void updateOrderStatus(String orderid, String username) {
        myOrderMapper.updateOrderStatus(orderid,username);
    }
    ...
    public PageResult pageQuery(QueryPageBean queryPageBean,String username) {
        //从QueryPageBean中拿到前端发送的数据(当前页码,每页显示的记录数,查询条件)
        Integer currentPage = queryPageBean.getCurrentPage();
        Integer pageSize = queryPageBean.getPageSize();
        String queryString = queryPageBean.getQueryString();
        //selsct * from t_checkitem limit 0,10 where ...
        //limit是基于Mybatis框架实现
//        PageHelper.startPage(currentPage, pageSize);
        //where由我们自己手动来处理
        List<MyOrder> page =  myOrderMapper.pageQuery(currentPage, pageSize, username);
        //page.getTotal();总记录数(total) page.getResult():当前页结果(rows)
        PageResult<MyOrder> result = new PageResult<>();
        result.setRows(page);
        result.setTotal(Long.parseLong(String.valueOf(page.size())));
        return result;
    }
