...
public class Order implements Serializable {
	...
	private String payType;//支付类型，1、微信支付、0 货到付款丶2支付宝支付
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, order.id) &&
				...
				Objects.equals(preMoney, order.preMoney) &&
				Objects.equals(postFee, order.postFee) &&
				Objects.equals(payMoney, order.payMoney) &&
				...
				Objects.equals(consignTime, order.consignTime) &&
				Objects.equals(endTime, order.endTime) &&
				Objects.equals(closeTime, order.closeTime) &&
				Objects.equals(shippingName, order.shippingName) &&
				Objects.equals(shippingCode, order.shippingCode) &&
				Objects.equals(username, order.username) &&
				Objects.equals(buyerMessage, order.buyerMessage) &&
				Objects.equals(buyerRate, order.buyerRate) &&
				...
				Objects.equals(sourceType, order.sourceType) &&
				Objects.equals(transactionId, order.transactionId) &&
				Objects.equals(orderStatus, order.orderStatus) &&
				Objects.equals(payStatus, order.payStatus) &&
				Objects.equals(consignStatus, order.consignStatus) &&
				Objects.equals(isDelete, order.isDelete);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, totalNum, totalMoney, preMoney, postFee, payMoney, payType, createTime, updateTime, payTime, consignTime, endTime, closeTime, shippingName, shippingCode, username, buyerMessage, buyerRate, receiverContact, receiverMobile, receiverAddress, sourceType, transactionId, orderStatus, payStatus, consignStatus, isDelete);
	}
}
